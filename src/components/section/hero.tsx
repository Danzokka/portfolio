  ...
  return (
    <section id="hero" className="relative overflow-hidden h-screen w-screen">
      ...
      <div className="flex flex-col items-center justify-center h-full relative z-10">
        <BlurFade delay={DELAY_TIME + 0 * 0.5} className="">
          <H1>Welcome to My Portfolio</H1>
        </BlurFade>
        <BlurFade delay={DELAY_TIME + 1 * 0.5} className="mt-4">
        <Lead align="center">
        ...
        <div className="mt-6 flex items-center justify-center px-4 w-full">
          <BlurFade delay={DELAY_TIME + 2 * 0.5} className="flex gap-4">
          <ShiningButton href="#about" className="mr-4 bg-black" size={"lg"}>
            About Me
          </ShiningButton>
          </BlurFade>
          <BlurFade delay={DELAY_TIME + 3 * 0.5} className="">
